...
void author()
{
    system("cls");
    printf("\n\n");
    printf("\t A project on Tic-Tac-Toe The Mathematical Game.....");
    printf("\n\n");
    printf("\n\n");
    printf("\n\n");
...
int problem()
{
    ...
    {
        // Check if the answer is correct for division
    ...
    {
        // Check if the answer is correct for addition
        if (answer == a + b)
        {
            return 1;
        }
